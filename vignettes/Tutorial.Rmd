...
Suppose we get the estimate of R2M for 10 different studies. We simulated the effects here first from a normal distribution with mean 0.5 and standard error 0.1. We simulated the corresponding standard error from a uniform distribution from 0.1 to 0.2.
